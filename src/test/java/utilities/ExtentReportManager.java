 ...
 */
	...
	String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());// time stamp repllame "Test Report timeStamp".html",
	...
	public void onTestFinish(ITestContext testContext) {
		...
		try {
			...
			email.setAuthenticator(new DefaultAuthentictor("pavanoltraining@gmail.com","password"));
